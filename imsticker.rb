...
# check if have downloaded templat
...
File.open(File.join(icons_directory, 'Awesome Stickers.png'), 'wb') { |f| f.write(File.read(rectangle_icon))}
...
# Rename project
puts "Renaming project name Ahuhuhuhuhu ..."
...
new_pbxproj = new_pbxproj.gsub('com.delightfuldev.awesome-stickers', info['identifier'])
